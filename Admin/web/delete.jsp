	...
	<body>
            ...
            <div id="header-status">
                <div class="container_12">
					...
					<ul id="nav">
                                ...
                                <li id="current"><a href="delete.jsp">Delete Data and User</a></li>
        ...
        <div class="container_12">
             ...
             <div class="grid_6">
                ...
                <div class="module">
                    <h2><span>Delete User</span></h2><br /><br />
                                      <form method="post" action="delete_user" name="myForm">
                                          <fieldset>
                                              &nbsp;&nbsp&nbspUser Name&nbsp;&nbsp<input type="text" name="name" ><br /><br />
         ...
         <div class="grid_6">
                ...
                <div class="module">
                    <h2><span>Delete Data</span></h2><br /><br />
                                      <form method="post" action="delete_file" name="myForm">
                                          <fieldset>
                                          &nbsp;&nbsp Choose file&nbsp;&nbsp<input type="text" name="file" ><br /><br />
                                         
                                       
                                        &nbsp;&nbsp Choose User&nbsp;&nbsp<input type="text" name="name" ><br /><br />
