	...
	<body>
            ...
            <div id="header-status">
                <div class="container_12">
					...
					<ul id="nav">
                                ...
                                <li id="current"><a href="add.jsp">Add User</a></li>
        ...
        <div class="container_12">
             ...
             <div class="grid_6">
                ...
                <div class="module">
                    <h2><span>Add User</span></h2><br /><br />
                                      <form method="post" action="add_user" name="myForm">
                                          <fieldset>
                                              &nbsp;&nbsp&nbspName&nbsp;&nbsp&nbsp&nbsp &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<input type="text" name="name" ><br /><br />
                                        
                                       &nbsp;&nbsp;&nbspProfession&nbsp;&nbsp &nbsp;&nbsp; &nbsp;<input type="text" name="prof"  ><br /><br />
                                           &nbsp;&nbsp;&nbspOrganisation&nbsp;&nbsp &nbsp;<input type="text" name="org" ><br /><br />
                                        
                                       &nbsp;&nbsp;&nbspUser Type&nbsp;&nbsp &nbsp;&nbsp; &nbsp;&nbsp;<input type="text" name="user"><br /><br />
                                           &nbsp;&nbsp;&nbspMobile no.&nbsp;&nbsp &nbsp;&nbsp; &nbsp;&nbsp;<input type="text" name="mob" ><br /><br />
                                        
                                       &nbsp;&nbsp;&nbspE-mail Id&nbsp;&nbsp &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;<input type="text" name="email"><br /><br />
                                           &nbsp;&nbsp;&nbspPassword&nbsp;&nbsp;&nbsp &nbsp;&nbsp; &nbsp;&nbsp;<input type="text" name="password" ><br /><br />
                                        
                                         
                                       &nbsp;&nbsp  <input class="submit-green" type="submit" value="Submit" />
                                       </fieldset>
				</form>
                        </div>
                </div>
